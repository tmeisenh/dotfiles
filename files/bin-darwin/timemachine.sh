...
$command "$LHOME/Documents" "$rsync_dir/Documents" -- --progress --no-perms --no-owner --no-group 
#$command "$LHOME/Music" "$rsync_dir/Music" -- --progress --no-perms --no-owner --no-group 
ret="$?"
